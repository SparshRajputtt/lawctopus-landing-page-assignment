...
return (
  <footer className="relative border-t border-stone-200/60 bg-white" aria-label="Footer">
    ...
    <div className="relative mx-auto max-w-7xl px-5 py-20 sm:px-6 lg:px-8">
      <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
        ...
        <motion.div {...fadeUp(0)} className="lg:col-span-4">
          <a
            ...
            className="inline-flex items-center gap-2 text-lg font-bold tracking-tight text-stone-900"
          >
            ...
            {quickLinks.map((link, i) => (
              <motion.li key={i} variants={staggerChild}>
                <button
                  ...
                  className="group flex items-center gap-1.5 text-sm text-stone-500 transition-colors hover:text-stone-900"
                >
                  {link.label}
            ...
            {socials.map((social, i) => {
              ...
              return (
                <motion.a
                  ...
                  whileTap={{ scale: 0.96 }}
                  className="flex h-9 w-9 items-center justify-center rounded-lg border border-stone-200 text-stone-400 transition-colors hover:border-stone-300 hover:bg-stone-50 hover:text-stone-700"
      ...
      <motion.div
        {...fadeUp(0.3)}
        className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-stone-100 pt-8 sm:flex-row"
      >
